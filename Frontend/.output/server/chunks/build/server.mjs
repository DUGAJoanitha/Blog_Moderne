import process from 'node:process';globalThis._importMeta_=globalThis._importMeta_||{url:"file:///_entry.js",env:process.env};import { hasInjectionContext, inject, getCurrentInstance, defineComponent, createElementBlock, shallowRef, provide, cloneVNode, h, computed, unref, shallowReactive, ref, Suspense, Fragment, createApp, onErrorCaptured, onServerPrefetch, createVNode, resolveDynamicComponent, reactive, effectScope, defineAsyncComponent, mergeProps, getCurrentScope, toRef, withCtx, nextTick, isReadonly, isRef, toValue, toRaw, useSSRContext, isShallow, isReactive } from 'vue';
import { x as parseURL, g as encodePath, d as decodePath, p as hasProtocol, s as isScriptProtocol, u as joinURL, F as withQuery, y as sanitizeStatusCode, i as getContext, $ as $fetch, b as defu, c as createError$1, h as executeAsync, q as hash } from '../_/nitro.mjs';
...
const _routes = [
  {
    name: "auth-register",
    path: "/auth/register",
    meta: { "middleware": "guest-only" },
    component: () => import('./register-BQscuasI.mjs')
  },
  {
    name: "dashboard-articles",
    path: "/dashboard/articles",
    meta: { "middleware": "auth" },
    component: () => import('./articles--cKx6BBd.mjs'),
    children: [
      {
        name: "dashboard-articles-create",
        path: "create",
        meta: { "middleware": "auth" },
        component: () => import('./create-5Iv_30B0.mjs')
      }
    ]
  },
  {
    ...
    meta: { "middleware": "auth" },
    component: () => import('./comments-1IAJl7ZT.mjs')
  },
  {
    name: "dashboard-media",
    path: "/dashboard/media",
    meta: { "middleware": "auth" },
    component: () => import('./media-5Ox9ew1F.mjs')
  },
  {
    name: "dashboard-newsletters",
    path: "/dashboard/newsletters",
    meta: { "middleware": "auth" },
    component: () => import('./newsletters-D3HJ3GWs.mjs')
  },
  {
    name: "dashboard",
    path: "/dashboard",
    meta: { "middleware": "auth" },
    component: () => import('./index-C8O-q5Td.mjs')
  },
  {
    name: "login",
    path: "/login",
    meta: { "middleware": "guest-only" },
    component: () => import('./login-DJdLsGfR.mjs')
  },
  {
    name: "index",
    path: "/",
    meta: { "middleware": "redirect-login" },
    component: () => import('./index-BKziQmG-.mjs')
  }
];
...
const namedMiddleware = {
  auth: () => import('./auth-Dfcwl3i9.mjs'),
  "guest-only": () => import('./guest-only-CuPBkYZ0.mjs'),
  "redirect-login": () => import('./redirect-login-DPoyuvIA.mjs')
};
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import('./error-404-_oovl-B7.mjs'));
    const _Error = defineAsyncComponent(() => import('./error-500-BUmu9mPE.mjs'));
...
export { _export_sfc as _, nuxtLinkDefaults as a, useRequestEvent as b, useRoute as c, defineNuxtRouteMiddleware as d, entry_default as default, encodeRoutePath as e, useRouter as f, useRuntimeConfig as g, navigateTo as n, resolveRouteObject as r, useNuxtApp as u };
