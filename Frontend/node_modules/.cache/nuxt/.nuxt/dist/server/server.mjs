import { hasInjectionContext, getCurrentInstance, shallowReactive, reactive, effectScope, getCurrentScope, inject, toRef, shallowRef, isReadonly, isRef, isShallow, isReactive, toRaw, defineComponent, createElementBlock, provide, cloneVNode, h, computed, toValue, onServerPrefetch, ref, nextTick, unref, Suspense, mergeProps, Fragment, withCtx, createVNode, useSSRContext, defineAsyncComponent, onErrorCaptured, resolveDynamicComponent, createApp } from "vue";
import { $fetch as $fetch$1 } from "C:/Users/M. DZIFA/blog/Frontend/node_modules/ofetch/dist/node.mjs";
import { baseURL } from "#internal/nuxt/paths";
import { createHooks } from "C:/Users/M. DZIFA/blog/Frontend/node_modules/hookable/dist/index.mjs";
import { getContext, executeAsync } from "C:/Users/M. DZIFA/blog/Frontend/node_modules/unctx/dist/index.mjs";
import { sanitizeStatusCode, createError as createError$1 } from "C:/Users/M. DZIFA/blog/Frontend/node_modules/@nuxt/nitro-server/dist/runtime/h3-compat.mjs";
import { shouldHydrate, setActivePinia, createPinia } from "pinia";
import { defu } from "C:/Users/M. DZIFA/blog/Frontend/node_modules/defu/dist/defu.mjs";
import { START_LOCATION, createMemoryHistory, createRouter, useRoute as useRoute$1, RouterView } from "vue-router";
import { hasProtocol, joinURL, parseURL, encodePath, decodePath, withQuery, isScriptProtocol } from "C:/Users/M. DZIFA/blog/Frontend/node_modules/ufo/dist/index.mjs";
import { debounce } from "C:/Users/M. DZIFA/blog/Frontend/node_modules/perfect-debounce/dist/index.mjs";
import { hash } from "C:/Users/M. DZIFA/blog/Frontend/node_modules/ohash/dist/index.mjs";
import { isPlainObject } from "@vue/shared";
import "C:/Users/M. DZIFA/blog/Frontend/node_modules/klona/dist/index.mjs";
...
const _routes = [
  {
    ...
    component: () => import("./_nuxt/register-BQscuasI.js")
  },
  {
    name: "dashboard-articles",
    path: "/dashboard/articles",
    meta: { "middleware": "auth" },
    component: () => import("./_nuxt/articles--cKx6BBd.js"),
    children: [
      {
        name: "dashboard-articles-create",
        path: "create",
        meta: { "middleware": "auth" },
        component: () => import("./_nuxt/create-5Iv_30B0.js")
      }
    ]
  },
  {
    ...
    meta: { "middleware": "auth" },
    component: () => import("./_nuxt/comments-1IAJl7ZT.js")
  },
  {
    name: "dashboard-media",
    path: "/dashboard/media",
    meta: { "middleware": "auth" },
    component: () => import("./_nuxt/media-5Ox9ew1F.js")
  },
  {
    name: "dashboard-newsletters",
    path: "/dashboard/newsletters",
    meta: { "middleware": "auth" },
    component: () => import("./_nuxt/newsletters-D3HJ3GWs.js")
  },
  {
    name: "dashboard",
    path: "/dashboard",
    meta: { "middleware": "auth" },
    component: () => import("./_nuxt/index-C8O-q5Td.js")
  },
  {
    name: "login",
    path: "/login",
    meta: { "middleware": "guest-only" },
    component: () => import("./_nuxt/login-DJdLsGfR.js")
  },
  {
    name: "index",
    path: "/",
    meta: { "middleware": "redirect-login" },
    component: () => import("./_nuxt/index-BKziQmG-.js")
  }
];
...
const namedMiddleware = {
  auth: () => import("./_nuxt/auth-Dfcwl3i9.js"),
  "guest-only": () => import("./_nuxt/guest-only-CuPBkYZ0.js"),
  "redirect-login": () => import("./_nuxt/redirect-login-DPoyuvIA.js")
};
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import("./_nuxt/error-404-_oovl-B7.js"));
    const _Error = defineAsyncComponent(() => import("./_nuxt/error-500-BUmu9mPE.js"));
